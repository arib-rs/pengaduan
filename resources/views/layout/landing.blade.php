        ...
        <div class="container-login100">
            <div class="wrap-login100" style="padding: 4rem">
                <div class="right-button">
                    <img src="{{ asset('template') }}/dist/img/p3mlogo-ori-hd-remake.png" alt="P3M Logo"
                        class="landing-logo">
                    <a href="{{ url('/login') }}" style="float: right">Sign In</a>
                </div>
                <div>
                    ...
                    <ol class="list" style="padding:0;margin-top:20px;margin-bottom:40px;line-height: 1.6;">
                        ...
                        <li>Adanya perintisan manajemen pelayanan berstandar ISO 9001 - 2000 di Dinas Perijinan dan
                            Penanaman Modal Kabupaten Sidoarjo.</li>
                        <li>Standar Internasional ( ISO 9001 - 9004 ) tentang pelayanan yang baik menyatakan bahwa untuk
                            mengukur keberhasilan pelayanan Pemerintah kepada masyarakat adalah senantiasa mendengar
                            keluhan-keluhan / pengaduan dari masyrakat (feedback from the customer)</li>
                        <li>Kebutuhan terhadap wadah komunikasi dua arah antara Pemerintah Kabupaten Sidoarjo dengan
                            masyarakat guna menghindari terjadinya kebuntuan informasi dan komunikasi</li>
                        <li>Masyarakat membutuhkan wadah yang tepat sebagai tempat mengadukan berbagai permasalahan yang
                            timbul sekaligus memperoleh jawaban yang dibutuhkan </li>
                    </ol>
                    ...
                    <h5>Media Respon</h5>
                    <ol class="list" style="padding:0;margin-top:20px;margin-bottom:40px;line-height: 1.6;">
                        <li>Papan pengumuman yang tersedia di Kantor Sekretariat P3M dan Kantor instansi Pemerintah
                            Kabupaten Sidoarjo, dan tempat lainnya</li>
